...
CREATE TABLE tblPerson (
    ...
    `strLocalFirstname` VARCHAR(150) NULL DEFAULT '' COMMENT 'The firstname of a person in local language (the language specified by LocalNameLanguage attribute).' ,
    `strLocalMiddlename` VARCHAR(150) NULL DEFAULT '' ,
    ...
    strISONationality varchar(50) DEFAULT '' COMMENT 'The nationality of the person.' ,
    strLocalSurname2 varchar(150) DEFAULT '',
    intLocalLanguage INT NOT NULL DEFAULT 0,
    strLatinTitle varchar(30) DEFAULT '',
    strLatinFirstname varchar(50) DEFAULT '' COMMENT 'The firstname of a person in Latin script/alphabet.' ,
    strLatinMiddlename varchar(50) DEFAULT '',
    strLatinSurname varchar(150) DEFAULT '' COMMENT 'The lastname of a person in Latin script/alphabet.' ,
    strLatinSurname2 varchar(150) DEFAULT '',

    intGender tinyint(4) DEFAULT 0,
    strGender varchar(50) DEFAULT '' COMMENT 'The sex of the person.' ,
    dtDOB date DEFAULT '0000-00-00' COMMENT 'The date of birth of this person.' ,
    strISOCountryOfBirth varchar(100) default '' COMMENT 'The country where the person was born. Note that this is not the nationality but simply the country where this person was born.' ,
    strRegionOfBirth varchar(100) default '' COMMENT 'The region (e.g., province or state) where the person was born.' ,
    strPlaceOfBirth varchar(100) default '' COMMENT 'The location (town, village or similar) where the person was born.' ,
    ...
    strPersonIdentifier varchar(20) DEFAULT '',
    strPersonCountryIdentifier varchar(6) DEFAULT '',
    ...
    intMinorMoveOtherThanFootball INT NOT NULL DEFAULT 0 COMMENT 'Flag for minor protection checks. Has the person moved to the country for reasons other than football',
    intMinorDistance INT NOT NULL DEFAULT 0 COMMENT 'Flag for minor protection checks. Is the distance from the players domicile more than a specified amount',
    intMinorEU INT NOT NULL DEFAULT 0 COMMENT 'Flag for minor protection checks. Transfer within EU',
    intMinorNone INT NOT NULL DEFAULT 0 COMMENT 'Flag for minor protection checks. None of the Above',
