...
CREATE TABLE `tblWFRule` (
  ...
  `intApprovalEntityID` int(11) NOT NULL DEFAULT '0' COMMENT 'Which Entity has to approve this rule--PROBABLY NOT NEEDED',
  ...
  `intProblemResolutionEntityID` int(11) NOT NULL DEFAULT '0' COMMENT '-----PROBABLY NOT NEEDED',
