...
sub facility_details {
    ...
    my %FieldDefinitions = (
        ...
        order => [ qw(intFacilityID strName intRecStatus strAbbrev strAddress1 strAddress2 strSuburb strState strPostalCode strCountry strPhone strPhone2 strFax strLGA intMapNumber strMapRef mapdesc dblLat dblLong mapblock)],
        sections => [
