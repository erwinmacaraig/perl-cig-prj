...
sub display_complete {
    ...
    if($clubObj->ID()) {
        ...
        $content = qq [<div class="col-md-12"><div class="alert"><div><span class="flash_success fa fa-check"></span><p>$self->{'Data'}->{'LevelNames'}{$Defs::LEVEL_CLUB} Added Successfully</p></div></div></div> ];
    }
    else {
